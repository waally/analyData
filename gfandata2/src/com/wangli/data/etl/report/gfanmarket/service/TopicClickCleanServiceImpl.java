...
public class TopicClickCleanServiceImpl implements TopicClickCleanService{
	...
	public int getCount(String dateTime) throws SQLException {
		...
		example.createCriteria().andVersionEqualTo("2").andDataTimeEqualTo(dateTime).andEventIdEqualTo("2301").andClientVersionIn(commonService.getStatisticsVersion());
		return clientEventLogDAO.countByExample(example);
	}

	@Override
	public void deleteRepeatDate(String dateTime, int behaviorId)
			throws SQLException {
	...
	@Override
	public Integer checkBannerId(String productId, GfanMarketBehavior behavior,
